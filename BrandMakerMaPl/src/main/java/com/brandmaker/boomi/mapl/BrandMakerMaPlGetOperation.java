...
public class BrandMakerMaPlGetOperation extends BaseGetOperation {

	private static final Logger Logger = java.util.logging.Logger.getLogger(BrandMakerMaPlGetOperation.class.getName());
	private MapsRestWrapper restWrapper;
	
    protected BrandMakerMaPlGetOperation(BrandMakerMaPlConnection conn) {
        super(conn);
    }
	...
	protected void executeGet(GetRequest request, OperationResponse response) {
		 ...
		 */
		switch ( BrandMakerMaPlBrowser.GetOperations.valueOf(objectTypeId) )
		{
			case TREES:
